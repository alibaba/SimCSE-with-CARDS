...
from .sick import SICKEntailmentEval, SICKEval
from .mrpc import MRPCEval
from .sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        params.get_align_uniform = False if 'get_align_uniform' not in params else params.get_align_uniform
