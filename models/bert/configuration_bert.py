...
class BertConfig(PretrainedConfig):
    ...
    Extended args:
        tie_word_embeddings (:obj:`bool`, `optional`, defaults to 1):
            Whether to tie the input embedding to the output embeddings.
        embedding_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the embedding layer.
        pooler_act (:obj:`str` or :obj:`Callable`, `optional`, defaults to :obj:`"tanh"`):
            The non-linear activation function (function or string) in the pooler. If string,
            :obj:`"gelu"`, :obj:`"relu"`, :obj:`"silu"` and :obj:`"gelu_new"` are supported.
        debug_config (:obj:`dict`, `optional`):
            Preserved argument for the debugging configurations. 
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.embedding_dropout_prob = embedding_dropout_prob or hidden_dropout_prob
